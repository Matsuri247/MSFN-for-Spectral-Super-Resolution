...
from NTIRE2020_dataset import TestDataset
...
parser.add_argument('--pretrained_model_path', type=str, default='../model_pth/MSFN/NTIRE2020/MSFN.pth')
parser.add_argument('--outf', type=str, default='./exp/2020/MSFN/')
...
def test(val_loader, model):
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        with torch.no_grad():
            ...
            #output = reconstruct(model, input, target, crop_size=opt.patch_size, stride=opt.stride)
